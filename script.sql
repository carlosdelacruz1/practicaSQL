...
create table matricula(
	matricula_num varchar(10) not null, --PK
...
create table revisiones(
	revisiones_num integer not null, --PK
	name varchar(10) not null
	);

alter table revisiones
add constraint revisiones_PK primary key(revisiones_num);
...
create table coches(
	...
	matricula_num varchar(10) not null, --FK
	...
	revisiones_num integer not null, --FK
...
alter table coches
add constraint coches_grupo_FK foreign key(idgrupo) references grupo_emrpesarial(idgrupo);
...
alter table coches
add constraint coches_matricula_num_FK foreign key(matricula_num) references matriculas(matricula_num);
...
insert into examen.fecha_compra  (idfecha, name, comentario)
...
insert into examen.polizas  (pnum_poliza , name, comentario)
...
insert into examen.revisiones (revisiones_num, name, comentario)
values ('1', 'Primera','');
...
insert into examen.coches (idcoche, idgrupo, idmarca, idmodelo, matricula_num, color, kilometraje, id_aseguradoras, num_poliza, revisiones, kilometros_revision, fecha, fecha_revision, precio_revision, comentario)
values ('0001', 'Renault Group','Renault', 'Megan','EU2891', 'VERDE', '2000', 'AXA', 'A234567', '1','1000','2018-02-07', '2018-02-07','500€','');

insert into examen.coches (idcoche, idgrupo, idmarca, idmodelo, matricula_num, color, kilometraje, id_aseguradoras, num_poliza, revisiones, kilometros_revision, fecha, fecha_revision, precio_revision, comentario)
values ('0002', 'Renault Group','Dacia', 'Sandero','EU2822', 'AMARILLO', '1000', 'MAPFRE', 'B234567', '2','2000','2019-10-07', '2020-02-07','500€','');
